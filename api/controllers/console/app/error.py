...
class ProviderQuotaExceededError(BaseHTTPException):
    ...
    description = "Your quota for CC-Bots Hosted Model Provider has been exhausted. " \
...
class ProviderModelCurrentlyNotSupportError(BaseHTTPException):
    ...
    description = "CC-Bots Hosted OpenAI trial currently not support the GPT-4 model."
    code = 400
