...
class AlreadySetupError(BaseHTTPException):
    ...
    description = "CC-Bots has been successfully installed. Please refresh the page or return to the dashboard homepage."
    code = 403


class NotSetupError(BaseHTTPException):
    error_code = 'not_setup'
    description = "CC-Bots has not been initialized and installed yet. " \
