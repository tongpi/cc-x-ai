    ...
    <div className='w-[800px] px-16 py-6'>
      ...
      <div className={rowClass}>
        ...
        <div>
          ...
          />
          <a className='flex items-center h-[18px] px-3 text-xs text-gray-500' href="https://cc.ai/advanced/datasets#how-to-write-a-good-dataset-description" target='_blank'>
