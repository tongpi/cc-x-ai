...
import type { App, AppCategory } from '@/models/chat'
import AppCard from '@/app/components/chat/category-app-card'
import { installApp } from '@/service/explore'
import AIChatContext from '@/context/chat-context'
import AIChat from '@/app/components/chat/chat'
...
const CategoryApps = ({
  ...
  const currCategoryDetail = (() => {
    if (isAllCategory)
      return { key: 'All', name: t('chat.category.All') }
