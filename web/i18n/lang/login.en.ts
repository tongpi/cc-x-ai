const translation = {
  ...
  welcome: 'Welcome to CC-Bots, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting CC-Bots Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join',
  joinTipStart: 'Invite you join',
  joinTipEnd: 'team on CC-Bots',
  invalid: 'The link has expired',
  explore: 'Explore CC-Bots',
